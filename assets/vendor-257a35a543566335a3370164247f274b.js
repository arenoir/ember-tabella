...
Object.defineProperty(e,"__esModule",{value:!0}),e.default=Ember.Component.extend(r.default,{layout:t.default,classNames:"ember-tabella__body-column",classNameBindings:["column.textAlign","column.isFixed:ember-tabella__body-column--fixed"],attributeBindings:"style",scrollLeft:0,scrollTop:0,model:null,onCellClick:function(){},content:Ember.computed("model","column",function(){var e=Ember.get(this,"model"),t=Ember.get(this,"column")
if(e&&t)return t.getContent(e)}),click:function(){var e=Ember.get(this,"column"),t=Ember.get(this,"model")
Ember.get(this,"onCellClick")(e,t)}})}),define("ember-tabella/components/ember-tabella/body-row",["exports","ember-tabella/templates/components/ember-tabella/body-row"],function(e,t){"use strict"
