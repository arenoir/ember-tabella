...
if(this._rawItems!==e){this._items&&this._items.removeArrayObserver&&this._items.removeArrayObserver(this,{willChange:function(){},didChange:"_needsRevalidate"}),this._rawItems=e
var t=Ember.A(e)
this.set("_items",t),t&&t.addArrayObserver&&t.addArrayObserver(this,{willChange:function(){},didChange:"_needsRevalidate"})}},updateScrollPosition:function(){if(this._scrollChange){var e=this.getAttr("scroll-left")
...
function r(e){return Ember.isEmpty(e)?0:e.reduce(function(e,t){return e+t.get("width")||0},0)}Object.defineProperty(e,"__esModule",{value:!0}),e.default=Ember.Component.extend({layout:t.default,classNames:["ember-tabella"],numFixedColumns:0,height:400,width:500,headerHeight:50,rowHeight:30,hasHeader:!0,attributeBindings:["style"],columns:null,sortedColumn:null,isSortReversed:!1,scrollLeft:0,scrollTop:0,content:null,onColumnClick:function(){},onColumnSort:function(){},onScroll:function(){},didReceiveAttrs:function(){this._super.apply(this,arguments),this.markFixedColumns()},markFixedColumns:function(){this.get("fixedColumns").setEach("isFixed",!0)},_columns:Ember.computed("columns.[]",function(){var e=this.get("columns")
return Ember.isEmpty(e)?[]:new Ember.A(e)}),style:Ember.computed("height",function(){var e=this.get("height")
return Ember.String.htmlSafe("height:"+e+"px;")}),fixedColumns:Ember.computed("columns.[]","numFixedColumns",function(){var e=this.get("columns")||[],t=this.get("numFixedColumns")||0
return new Ember.A(e.slice(0,t))}),_fixedColumnsWidth:Ember.computed("fixedColumns.@each.width",function(){return r(this.get("fixedColumns"))}),rowWidth:Ember.computed("columns.@each.width",function(){return r(this.get("columns"))}),headerRowWith:Ember.computed("rowWidth",function(){return this.get("rowWidth")+15}),bodyHeight:Ember.computed("height","_headerHeight","_footerHeight",function(){return this.get("height")-(this.get("_headerHeight")+this.get("_footerHeight"))}),_headerHeight:Ember.computed("hasHeader","headerHeight",function(){return this.get("hasHeader")?this.get("headerHeight"):0}),_footerHeight:Ember.computed("hasFooter","footerHeight",function(){return this.get("hasFooter")?this.get("footerHeight"):0}),actions:{updateScrollPosition:function(e,t){this.setProperties({scrollTop:t,scrollLeft:e}),e!==this._left&&(this.$(".ember-tabella__header:first").scrollLeft(e),this._left=e),this.get("onScroll")(e,t)}}})}),define("ember-tabella/components/ember-tabella/body-column",["exports","ember-tabella/templates/components/ember-tabella/body-column","ember-tabella/mixins/column-style"],function(e,t,r){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=Ember.Component.extend(r.default,{layout:t.default,classNames:"ember-tabella__body-column",classNameBindings:["column.textAlign","column.isFixed:ember-tabella__body-column--fixed"],attributeBindings:"style",scrollLeft:0,scrollTop:0,model:null,onCellClick:function(){},content:Ember.computed("model","column",function(){var e=this.get("model"),t=this.get("column")
if(e&&t)return t.getContent(e)}),click:function(){var e=this.get("column"),t=this.get("model")
this.get("onCellClick")(e,t)}})}),define("ember-tabella/components/ember-tabella/body-row",["exports","ember-tabella/templates/components/ember-tabella/body-row"],function(e,t){"use strict"
...
Object.defineProperty(e,"__esModule",{value:!0}),e.default=Ember.Component.extend({layout:t.default,classNames:["ember-tabella__body"],attributeBindings:["style"],style:Ember.computed("height",function(){var e=this.get("height")
return Ember.String.htmlSafe("height:"+e+"px;")}),onCellClick:function(){},onScroll:function(){},actions:{scrollChange:function(e,t){this.get("onScroll")(e,t)}}})}),define("ember-tabella/components/ember-tabella/header-column",["exports","ember-tabella/templates/components/ember-tabella/header-column","ember-tabella/mixins/column-style"],function(e,t,r){"use strict"
...
this._offset!==t&&(this._offset=t,this.get("onResize")(t))}})}),define("ember-tabella/components/ember-tabella/header-row",["exports","ember-tabella/templates/components/ember-tabella/header-row"],function(e,t){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=Ember.Component.extend({layout:t.default,columns:null,width:0,height:0,scrollLeft:0,scrollTop:0,classNames:["ember-tabella__header-row"],attributeBindings:["style"],sortedColumn:null,isSortReversed:!1,style:Ember.computed("width","height",function(){var e=this.get("width"),t=this.get("height")
...
Object.defineProperty(e,"__esModule",{value:!0}),e.default=Ember.Component.extend({layout:t.default,tagName:"span",sort:null,classNames:["ember-tabella__header-sort-indicator"],classNameBindings:["sortClass"],sortClass:Ember.computed("sort",function(){var e=this.get("sort")
if(e)return"ember-tabella__header-sort-indicator--"+e}),content:Ember.computed("sort",function(){switch(this.get("sort")){case"desc":return"↓"
case"asc":return"↑"
default:return"↕"}})})}),define("ember-tabella/mixins/column-style",["exports"],function(e){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=Ember.Mixin.create({style:Ember.computed("column.{width,isFixed}","scrollLeft",function(){var e="width:"+this.get("column.width")+"px;"
return this.get("column.isFixed")&&(e+="left:"+this.get("scrollLeft")+"px;"),Ember.String.htmlSafe(e)})})}),define("ember-tabella/models/column",["exports"],function(e){"use strict"
Object.defineProperty(e,"__esModule",{value:!0}),e.default=Ember.Object.extend({columnName:void 0,contentPath:void 0,minWidth:25,maxWidth:void 0,isResizable:!0,textAlign:"text-align-right",templateName:"ember-tabella/body-column",headerTemplateName:"ember-tabella/header-column",width:Ember.computed.oneWay("_width"),_width:150,getContent:function(e){var t=this.get("contentPath")
